...
import favpolls from '../assets/projects/favpolls.png';
...
const PROJECTS_DATA: ListItem[] = [
    ...
    {
        id: 2,
        title: "Poll Creator Platform: favpolls.com",
        url: "https://favpolls.com",
        img: favpolls,
        highlight: "ASP.NET Core / C# / jQuery / CSS / SQL Server / Azure",
        date: "Jul-Sep 2023",
        desc: "This was a fun side project for me that I made so I can enhance my skills in ASP.NET Core and C#. Users can create polls, share them, configure them with certain settings (deadline, captcha, hide results), and make accounts to monitor their polls! I have used jQuery for handling the frontend alongside CSS. Poll votes are monitored using IP addresses and cookie data with user accounts. Authentication was created by utilizing the Identity package in ASP.NET Core and SQL Server. The database was accessed via the usage of Entity Framework Core."
    },
    {
        id: 3,
